...
#define  GPIO_OLED_SCLK_Pin     GPIO_Pin_8							/* D0 */
#define  GPIO_OLED_PIN_Pin     	GPIO_Pin_9							/* D1 */
#define  GPIO_OLED_RES_Pin     	GPIO_Pin_10							/* RES */
#define  GPIO_OLED_DC_Pin     	GPIO_Pin_11							/* DC */
...
#define OLED_RST_Clr() GPIO_ResetBits(GPIOC,GPIO_Pin_10)	//RES RES => 接RES引脚
#define OLED_RST_Set() GPIO_SetBits(GPIOC,GPIO_Pin_10)

#define OLED_DC_Clr() GPIO_ResetBits(GPIOC,GPIO_Pin_11)	//DC  DC  => 接DC引脚 
#define OLED_DC_Set() GPIO_SetBits(GPIOC,GPIO_Pin_11)

/* 使用4线串行接口时使用 */ 
#define OLED_SCLK_Clr() GPIO_ResetBits(GPIOC,GPIO_Pin_8)//CLK D0  => 接D0引脚
#define OLED_SCLK_Set() GPIO_SetBits(GPIOC,GPIO_Pin_8)

#define OLED_SDIN_Clr() GPIO_ResetBits(GPIOC,GPIO_Pin_9)//PIN D1  => 接D1引脚
